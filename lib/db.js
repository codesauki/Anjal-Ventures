...
export async function seedDefaults() {
  ...
  const defaultSettings = {
    ...
    company_email2: 'developers@anjalventures.com',
    company_phone: '',
    company_whatsapp: '2348164135836',
    company_address: 'No. 4, MJG Global Ventures Complex, Kolomi Ali Street, Sabon Pegi, Damaturu, Yobe State, Nigeria',
    company_cac: '9258709',
    company_duns: '352294840',
    company_tin: '2623553716975',
    hero_badge: 'CAC Registered: 9258709 · D-U-N-S: 352294840 · Active',
    hero_title: 'We build the digital products businesses actually use.',
    hero_description: 'From websites and mobile apps to marketplaces, SaaS platforms, digital automations and internal systems, Anjal Ventures turns ideas into working digital products for individuals, businesses and organisations — designed, built and maintained from Nigeria.',
    hero_tagline: 'Built for people. Built for businesses. Built to work.',
  ...
  await sql`
    ...
    WHERE key = 'company_address'
      AND value = 'Damaturu, Yobe State, Nigeria'
  `

  await sql`
    UPDATE settings
    SET value = '9258709', updated_at = NOW()
    WHERE key = 'company_cac'
      AND (value = 'BN 9258709' OR value LIKE 'BN %' OR value LIKE 'BN-%')
  `

  await sql`
    INSERT INTO settings (key, value) VALUES ('company_duns', '352294840')
    ON CONFLICT (key) DO NOTHING
  `
  ...
  await sql`
    UPDATE settings
    SET value = 'developers@anjalventures.com', updated_at = NOW()
    WHERE key = 'company_email2'
      AND (value = 'contact@anjal.com' OR value LIKE '%@anjal.com' OR value IS NULL OR value = '')
  `
