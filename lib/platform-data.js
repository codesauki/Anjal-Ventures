...
export async function getPlatformData() {
  try {
    ...
    if (!settings.company_duns) settings.company_duns = '352294840'
    if (!settings.company_email || settings.company_email.includes('@gmail.com')) {
      settings.company_email = 'contact@anjalventures.com'
    }
    if (!settings.company_email2 || settings.company_email2.includes('@anjal.com') || settings.company_email2 === settings.company_email) {
      settings.company_email2 = 'developers@anjalventures.com'
    }
